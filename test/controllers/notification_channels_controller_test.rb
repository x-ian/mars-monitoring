...
class NotificationChannelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notification_channel" do
    assert_difference('NotificationChannel.count') do
      post notification_channels_url, params: { notification_channel: { name: @notification_channel.name } }
    end
  ...
  test "should update notification_channel" do
    patch notification_channel_url(@notification_channel), params: { notification_channel: { name: @notification_channel.name } }
